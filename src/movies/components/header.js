...
const HeaderMovie = () => {
  ...
  return (
    <Header>
      <DivLogoHeader style={{ color: 'white', fontSize: '20px', fontWeight:'500'}}> 
        <PandaIcon style={{ fontSize: '31px' }} />
        UDIAHN
        <HeartIcon style={{ color: 'gren', fontSize: '10px' }} />
        <HeartIcon style={{ color: 'yellow', fontSize: '15px' }} />
        <HeartIcon style={{ color: 'red', fontSize: '20px' }} />
      ...
      <Menu theme="dark" mode="horizontal" defaultSelectedKeys={pathname} >
        ...
        {info !==null &&
          <Menu.Item onClick = {() => logoutUser()} style={{ float:'right' }}>
            <span>Logout</span>
          </Menu.Item>
        }
